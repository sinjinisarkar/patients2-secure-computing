...
public class AppServlet extends HttpServlet {
  ...
  // FIX FOR FLAW 2: changed the query constants for username and pasword to use ? placeholders 
  private static final String AUTH_QUERY = "select * from user where username=? and password=?";
  // FIX FOR FLAW 2: changed the query constants for surname to use ? placeholder
  ...
  // NOTE: Returning userId (instead of boolean) improves clarity and supports safer access control
